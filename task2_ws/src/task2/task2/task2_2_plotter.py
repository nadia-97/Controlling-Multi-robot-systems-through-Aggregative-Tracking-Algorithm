...
class Agent(Node): 
    ...
    # This function is called every time a message is received from an agent 
    ...
    def timer_callback(self): 
        ...
        if self.t < self.MAXITERS: 
            ...
            if all_received:
                ## data extraction from the received data
            ...
            ## start plotting when the iterations are done
